SELECT
      SELECT
        PRO.PRO_CODIGO, --chave primária orcle V
        PRO.PRO_DESCRICAO, -- descrição(título) do produto V
        PRO.PRO_REFERENCIA, -- referência única do produto V
        PRO.PRO_CODIGOBARRA, -- código de barras do produto V
        PRO.PRO_UNIDADE, -- unidade de medida do produto V
        PRO.PRO_PARTNUM_SKU, -- SKU do produto V
        PRO.PRO_MODELO_COM, -- modelo do produto V
        PRO.PRO_DES_TECNICA, -- descrição técnica do produto V
        PRO.PRO_APRESENTACAO, -- apresentação do produto v
        PRO.PRO_URL_AMIGAVEL, -- slug do produto V
        CASE 
        ...
        END AS PRO_CONTEUDO_EMB, -- NÃO É POSSÍVEL UTILIZAR COALESCE, POIS OS CAMPOS TEM CONJUNTO DE CARACTERES DIFERENTES
                                 -- CONTEÚDO DA EMBALAGEM DO PRODUTO V
