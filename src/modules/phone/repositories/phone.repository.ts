...
export class PhoneRepository {
  ...
  async create(phoneData: Partial<Phone>): Promise<Phone> {
    ...
    if (phoneData.isDefault) {
      await this.unsetDefaultPhone(phoneData.profileId);
    }
  ...
  async update(id: number, phoneData: Partial<Phone>): Promise<Phone> {
    if (phoneData.isDefault) {
      ...
      await this.unsetDefaultPhone(phone.profileId);
    }
  ...
  private async unsetDefaultPhone(profileId: number): Promise<void> {
